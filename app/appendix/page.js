...
const logbookEntries = [
  ...
  { Member: 'Krishna', Date: '14/2/2025', Efforts: 'Made flowchart for typical organisational structure that we can use as inspiration', Hours: 2 },
  { Member: 'Alexey S.', Date: '19/2/2025', Efforts: 'Group discussion to finalise PIP presentation', Hours: 2 },
  { Member: 'James', Date: '19/2/2025', Efforts: 'Made the PIP Presentation', Hours: 2.5 },
  ...
  { Member: 'Pablo', Date: '26/2/2025', Efforts: 'Researched on possible aerodynamic designs', Hours: 2.5 },
  { Member: 'Arthur M.', Date: '03/02/2025', Efforts: 'Further development for fin design', Hours: 2.5 },
  { Member: 'Prabesh', Date: '03/05/2025', Efforts: 'Did extensive research on materials for rocket design, with sources', Hours: 3 },
  { Member: 'James', Date: '03/05/2025', Efforts: 'Added onto Prabesh\'s research', Hours: 2 },
  { Member: 'Pablo', Date: '05/03/2025', Efforts: 'Researched into cheap, resistant and reliable materials', Hours: 2.5 },
  ...
  { Member: 'Alrich', Date: '24/3/2025', Efforts: 'Performed Flow Simulation on aforementioned nose cones', Hours: 3 },
  { Member: 'Partha', Date: '25/3/2025', Efforts: 'Called a meeting to discuss next steps. Discussed potentiality for launch simulation to be done in the Sim suite', Hours: 2 },
  ...
  { Member: 'Partha', Date: '04/03/2025', Efforts: 'Creates simulated water bottle accurate in dimensions in CAD (for final assembly)', Hours: 3 },
  { Member: 'James', Date: '20/4/2025', Efforts: 'Gathered measurements for all existing nosecones and predictions for how they will perform', Hours: 2.5 },
  { Member: 'Partha', Date: '30/04/2025', Efforts: 'Creates sleeve for fins for rocket in CAD', Hours: 3 },
  ...
  { Member: 'Partha', Date: '30/04/2028', Efforts: 'Creates final assembled rocket in CAD', Hours: 3.5 },
  { Member: 'Pablo', Date: '05/07/2025', Efforts: 'Summons meeting to discuss next steps. Next steps are figured out', Hours: 2 },
  ...
  { Member: 'Alrich', Date: '05/07/2025', Efforts: 'Creates part drawings for rocket and Final checks for all CAD files', Hours: 3.5 },
  { Member: 'James', Date: '05/10/2025', Efforts: 'Came up with the final measurements for the rocket', Hours: 2.5 },
  { Member: 'Pablo', Date: '13/52025', Efforts: 'Completed the risk assesment with help from alrich', Hours: 2.5 },
  ...
  { Member: 'James', Date: '14/10/2025', Efforts: 'Ran additional lab tests on thrust and recorded the data', Hours: 3 },
  { Member: 'Pablo', Date: '14/10/2025', Efforts: 'Ran additional lab tests on thrust and recorded the data', Hours: 3 },
  ...
  { Member: 'Krishna', Date: '19/05/2025', Efforts: 'Made an instructions guide to launch the water rocket.', Hours: 2.5 },
  { Member: 'Krishna', Date: '15/05/2025', Efforts: 'Updated some information and modifications on the website', Hours: 2.5 },
];
